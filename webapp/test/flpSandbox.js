		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Final Project ProDev",
									"targetURL": "#comlab2devfinalprojectprodev-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devfinalprojectprodev-display": {
								"semanticObject": "comlab2devfinalprojectprodev",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.finalprojectprodev",
									"url": sap.ui.require.toUrl("com/lab2dev/finalprojectprodev")
								}
							}
						}
					}
